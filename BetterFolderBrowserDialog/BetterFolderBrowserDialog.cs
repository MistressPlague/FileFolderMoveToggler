...
using System.IO;
using Plague.Dialogs.WinForms.Interop;

namespace Plague.Dialogs.WinForms
{
    /// <summary>
    ...
    public sealed class BetterFolderBrowserDialog : CommonDialog
    {
        ...
        /// <summary>
        /// Creates a new instance of the <see cref="BetterFolderBrowserDialog" /> class.
        /// </summary>
        ...
        protected override bool RunDialog(IntPtr hwndOwner)
        {
            ...
            Plague.Dialogs.WinForms.Interop.IFileDialog dialog = null;
            try
            {
                dialog = new Plague.Dialogs.WinForms.Interop.NativeFileOpenDialog();
        ...
        /// <summary>
        /// Releases the unmanaged resources used by the <see cref="BetterFolderBrowserDialog" /> and optionally releases the managed resources.
        /// </summary>
        ...
        private void SetDialogProperties(Plague.Dialogs.WinForms.Interop.IFileDialog dialog)
        {
            // Description
            if( !string.IsNullOrEmpty(_description) )
            {
                ...
                {
                    Plague.Dialogs.WinForms.Interop.IFileDialogCustomize customize = (Plague.Dialogs.WinForms.Interop.IFileDialogCustomize)dialog;
        ...
        private void GetResult(Plague.Dialogs.WinForms.Interop.IFileDialog dialog)
        {
            Plague.Dialogs.WinForms.Interop.IShellItem item;
